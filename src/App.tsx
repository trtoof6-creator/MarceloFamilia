      ...
      <section id="inicio" className="relative min-h-[calc(100vh-112px)] sm:min-h-[calc(100vh-120px)] lg:min-h-[720px] flex items-center overflow-hidden bg-[#101827]">
        ...
        <div className="absolute inset-0">
          <img
            ...
            className="w-full h-full object-cover object-center lg:object-[62%_center] select-none"
            referrerPolicy="no-referrer"
          />
          <div className="absolute inset-0 bg-[#071427]/55"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-[#071427]/95 via-[#071427]/72 to-[#071427]/20"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-[#071427]/65 via-transparent to-[#071427]/20"></div>
        </div>
                ...
                <div className="relative rounded bg-[#FDFBF9] p-2 border border-[#E0D9CD] shadow-lg overflow-hidden">
                  <div className="relative rounded overflow-hidden">
                    <img
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#1B365D]/55 via-[#1B365D]/18 to-transparent pointer-events-none"></div>
                  </div>
