...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF9] font-sans text-[#2C3E50] antialiased selection:bg-[#E5D5C5] selection:text-[#1B365D]">
      ...
      {/* HERO SECTION */}
      <section id="inicio" className="relative min-h-[680px] sm:min-h-[700px] lg:min-h-[640px] overflow-hidden bg-[#071A33] flex items-center">
        {/* Foto da família em fundo total */}
        <img
          src={lawOfficeBg}
          alt="Família representando acolhimento no Direito de Família"
          className="absolute inset-0 w-full h-full object-cover object-[center_top] select-none"
          referrerPolicy="no-referrer"
        />

        {/* Overlays para deixar igual referência: azul forte à esquerda e leitura no texto */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#071A33] via-[#071A33]/62 to-[#071A33]/5" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/15 via-transparent to-[#071A33]/12" />
        <div className="absolute inset-y-0 left-0 w-[48%] bg-[#071A33]/28 backdrop-blur-[1px]" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-10 pb-12">
          <motion.div 
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#071A33]/25 border border-[#C59B27]/70 backdrop-blur-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-[#C59B27]"></span>
              <span className="text-xs font-bold uppercase tracking-[0.22em] text-[#C59B27] font-sans">
                Direito de Família
              </span>
            </motion.div>
            ...
            <motion.h1 
              variants={fadeInUp} 
              className="font-serif text-[2.45rem] sm:text-5xl lg:text-6xl font-semibold tracking-tight text-white leading-[1.08] drop-shadow-[0_2px_16px_rgba(0,0,0,0.35)]"
            >
            ...
            <motion.p 
              variants={fadeInUp} 
              className="text-base sm:text-lg text-white/90 leading-relaxed max-w-xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.35)]"
            >
            ...
            <motion.div variants={fadeInUp} className="pt-4 space-y-4 sm:space-y-0 sm:flex sm:items-center sm:gap-4">
              <button
                ...
                id="hero_cta_btn"
                className="w-full sm:w-auto px-8 py-4 bg-[#1B365D] hover:bg-[#152947] border border-[#C59B27]/45 text-[#FAF6F0] font-bold tracking-wide rounded-sm shadow-xl transition-all duration-300 flex items-center justify-center gap-3 group"
              >
                <MessageSquare className="w-5 h-5 text-[#C59B27]" />
                Falar pelo WhatsApp
              ...
              <a
                href="#sobre"
                className="w-full sm:w-auto px-8 py-4 border border-white/45 hover:border-[#C59B27] text-white font-semibold rounded-sm tracking-wide text-center block transition-all hover:bg-white/10 backdrop-blur-sm"
              >
                Conhecer Trabalho
              </a>
            </motion.div>
            ...
            <motion.div 
              variants={fadeInUp} 
              className="pt-6 sm:pt-8 border-t border-white/20 grid grid-cols-1 min-[380px]:grid-cols-3 gap-4 max-w-2xl"
            >
              <div>
                <h4 className="font-serif text-xl font-bold text-white">100%</h4>
                <p className="text-xs text-white/85 font-medium leading-tight">Confidencialidade</p>
              </div>
              <div>
                <h4 className="font-serif text-xl font-bold text-white">Foco</h4>
                <p className="text-xs text-white/85 font-medium leading-tight">Soluções Consensuais</p>
              </div>
              <div>
                <h4 className="font-serif text-xl font-bold text-white">Rigor</h4>
                <p className="text-xs text-white/85 font-medium leading-tight">Técnico Estratégico</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            >
              <div className="relative max-w-[320px] sm:max-w-sm mx-auto group">
                {/* Base azul atrás da foto para criar o efeito da referência */}
                <div className="absolute -left-8 sm:-left-12 top-8 bottom-8 w-[72%] rounded-md bg-gradient-to-r from-[#071A33] via-[#123968]/85 to-transparent blur-[1px]"></div>
                ...
                {/* Image Frame com gradiente azul real no lado esquerdo da foto */}
                <div className="relative overflow-hidden rounded bg-[#FDFBF9] p-2 border border-[#E0D9CD] shadow-lg">
                  <img
                    ...
                    className="relative z-0 w-full h-auto object-contain rounded select-none filter contrast-[1.02]"
                    referrerPolicy="no-referrer"
                  />

                  <div className="absolute inset-2 rounded pointer-events-none z-10 bg-gradient-to-r from-[#071A33]/85 via-[#123968]/45 to-transparent"></div>
                  <div className="absolute inset-2 rounded pointer-events-none z-10 bg-gradient-to-t from-[#071A33]/22 via-transparent to-transparent"></div>
                  
                  {/* Small gold label overlay */}
                  <div className="absolute z-20 bottom-4 right-4 sm:bottom-5 sm:right-5 bg-[#1B365D] text-[#FAF6F0] py-1.5 px-3.5 rounded border border-[#C5A880]/30 shadow-sm">
