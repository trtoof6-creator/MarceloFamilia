...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF9] font-sans text-[#2C3E50] antialiased selection:bg-[#E5D5C5] selection:text-[#1B365D]">
      ...
      {/* HERO SECTION */}
      <section id="inicio" className="relative min-h-[650px] sm:min-h-[680px] lg:min-h-[700px] overflow-hidden bg-[#071B32] flex items-center">
        {/* Foto da família como fundo do hero - sem cortar os rostos no desktop */}
        <div className="absolute inset-0 bg-[#FDFBF9]">
          <img
            src={lawOfficeBg}
            alt="Família reunida representando acolhimento em Direito de Família"
            className="hidden md:block absolute right-0 top-0 h-full w-auto max-w-none object-contain object-right select-none"
            referrerPolicy="no-referrer"
          />
          <img
            src={lawOfficeBg}
            alt="Família reunida representando acolhimento em Direito de Família"
            className="md:hidden absolute inset-0 h-full w-full object-cover object-[58%_center] select-none"
            referrerPolicy="no-referrer"
          />
        </div>

        {/* Overlay azul igual referência: forte à esquerda, suave à direita */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(90deg, rgba(6, 25, 48, 0.98) 0%, rgba(8, 33, 63, 0.92) 28%, rgba(8, 33, 63, 0.66) 48%, rgba(8, 33, 63, 0.22) 68%, rgba(255,255,255,0.04) 100%)"
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(180deg, rgba(6, 25, 48, 0.18) 0%, rgba(6, 25, 48, 0.04) 45%, rgba(6, 25, 48, 0.25) 100%)"
          }}
        />

        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10 py-16 sm:py-20 lg:py-24">
          <motion.div
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#C59B27]/10 border border-[#C59B27]/60">
              <span className="w-1.5 h-1.5 rounded-full bg-[#C59B27]"></span>
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#D7AE3C] font-sans">
                Direito de Família
              </span>
            </motion.div>
            ...
            <motion.h1
              variants={fadeInUp}
              className="font-serif text-[2.45rem] sm:text-5xl lg:text-[4.15rem] font-semibold tracking-tight text-white leading-[1.05] drop-shadow-sm"
            >
              Orientação jurídica para decisões que impactam <span className="text-[#C59B27]">sua família.</span>
            </motion.h1>
            ...
            <motion.div variants={fadeInUp} className="pt-4 flex flex-col sm:flex-row gap-4">
              <button
                ...
                id="hero_cta_btn"
                className="w-full sm:w-auto px-8 py-4 bg-[#1B365D] hover:bg-[#102844] border border-[#C59B27]/50 text-[#FAF6F0] font-bold tracking-wide rounded-sm shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 group"
              >
                <MessageSquare className="w-5 h-5 text-[#C59B27]" />
                Falar pelo WhatsApp
              ...
              <a
                href="#sobre"
                className="w-full sm:w-auto px-8 py-4 border border-white/45 hover:border-[#C59B27] text-white font-semibold rounded-sm tracking-wide text-center block transition-all hover:bg-white/10"
              >
                Conhecer Trabalho
              </a>
            </motion.div>
            ...
            <motion.div
              variants={fadeInUp}
              className="pt-6 sm:pt-8 border-t border-white/22 grid grid-cols-3 gap-4 max-w-2xl"
            >
              <div>
                <h4 className="font-serif text-lg sm:text-xl font-bold text-white">100%</h4>
                <p className="text-xs sm:text-sm text-white/85 font-medium leading-tight">Confidencialidade</p>
              </div>
              <div>
                <h4 className="font-serif text-lg sm:text-xl font-bold text-white">Foco</h4>
                <p className="text-xs sm:text-sm text-white/85 font-medium leading-tight">Soluções Consensuais</p>
              </div>
              <div>
                <h4 className="font-serif text-lg sm:text-xl font-bold text-white">Rigor</h4>
                <p className="text-xs sm:text-sm text-white/85 font-medium leading-tight">Técnico Estratégico</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            >
              <div className="relative max-w-[280px] sm:max-w-sm mx-auto group">
                {/* Bloco azul atrás da foto para criar a lateral igual à referência */}
                <div className="absolute -left-8 sm:-left-12 top-8 bottom-8 w-28 sm:w-36 rounded-md bg-[#071B32] shadow-2xl"></div>
                <div className="absolute -left-10 sm:-left-16 top-12 bottom-12 w-32 sm:w-44 rounded-md bg-gradient-to-r from-[#071B32] via-[#0B2A4C]/85 to-transparent blur-[1px]"></div>
                ...
                {/* Image Frame with strong blue gradient on the left side */}
                <div className="relative overflow-hidden rounded bg-[#FDFBF9] p-2 border border-[#E0D9CD] shadow-lg">
                  <img
                    src={lawyerMarcelo}
                  ...
                  {/* Gradiente azul real por cima da foto, saindo da esquerda */}
                  <div className="absolute inset-2 rounded pointer-events-none bg-gradient-to-r from-[#071B32]/80 via-[#0B2A4C]/42 to-transparent"></div>
                  <div className="absolute inset-2 rounded pointer-events-none bg-gradient-to-t from-[#071B32]/40 via-transparent to-transparent"></div>
                  
                  {/* Small gold label overlay */}
                  <div className="absolute bottom-4 right-4 sm:bottom-5 sm:right-5 z-10 bg-[#1B365D] text-[#FAF6F0] py-1.5 px-3.5 rounded border border-[#C5A880]/30 shadow-sm">
