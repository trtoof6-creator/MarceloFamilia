...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF9] font-sans text-[#2C3E50] antialiased selection:bg-[#E5D5C5] selection:text-[#1B365D]">
      ...
      {/* HERO SECTION */}
      <section id="inicio" className="relative min-h-[calc(100vh-112px)] sm:min-h-[calc(100vh-120px)] lg:min-h-[720px] flex items-center overflow-hidden bg-[#101827]">
        {/* Full hero family background */}
        <div className="absolute inset-0">
          <img
            src={lawOfficeBg}
            alt="Família representando acolhimento no Direito de Família"
            className="w-full h-full object-cover object-center sm:object-contain sm:object-right select-none"
            referrerPolicy="no-referrer"
          />
          <div className="absolute inset-0 bg-[#071427]/28"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-[#071427]/96 via-[#071427]/62 to-[#071427]/5"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-[#071427]/58 via-transparent to-[#071427]/10"></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16 sm:py-20 lg:py-28">
          <motion.div 
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#071427]/35 border border-[#C59B27]/45 backdrop-blur-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-[#C59B27]"></span>
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#D6A935] font-sans">
                Direito de Família
              </span>
            </motion.div>
            ...
            <motion.h1 
              variants={fadeInUp} 
              className="font-serif text-[2.3rem] sm:text-5xl lg:text-6xl font-semibold tracking-tight text-[#FDFBF9] leading-[1.08] drop-shadow-sm"
            >
              Orientação jurídica para decisões que impactam <span className="text-[#D6A935]">sua família.</span>
            </motion.h1>

            <motion.p 
              variants={fadeInUp} 
              className="text-base sm:text-xl text-[#FDFBF9]/88 leading-relaxed max-w-2xl drop-shadow-sm"
            >
            ...
            <motion.div variants={fadeInUp} className="pt-4 space-y-4 sm:space-y-0 sm:flex sm:items-center sm:gap-4">
              <button
                ...
                id="hero_cta_btn"
                className="w-full sm:w-auto px-8 py-4 bg-[#1B365D] hover:bg-[#152947] border border-[#C59B27]/50 text-[#FAF6F0] font-bold tracking-wide rounded-sm shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-3 group"
              >
                <MessageSquare className="w-5 h-5 text-[#C59B27]" />
                Falar pelo WhatsApp
              ...
              <a
                href="#sobre"
                className="w-full sm:w-auto px-8 py-4 border border-[#FDFBF9]/45 hover:border-[#C59B27] text-[#FDFBF9] font-semibold rounded-sm tracking-wide text-center block transition-all hover:bg-[#FDFBF9]/10 backdrop-blur-sm"
              >
                Conhecer Trabalho
              </a>
            </motion.div>
            ...
            <motion.div 
              variants={fadeInUp} 
              className="pt-6 sm:pt-8 border-t border-[#FDFBF9]/20 grid grid-cols-1 min-[380px]:grid-cols-3 gap-4 max-w-2xl"
            >
              <div>
                <h4 className="font-serif text-lg font-bold text-[#FDFBF9]">100%</h4>
                <p className="text-xs text-[#FDFBF9]/75 font-medium leading-tight">Confidencialidade</p>
              </div>
              <div>
                <h4 className="font-serif text-lg font-bold text-[#FDFBF9]">Foco</h4>
                <p className="text-xs text-[#FDFBF9]/75 font-medium leading-tight">Soluções Consensuais</p>
              </div>
              <div>
                <h4 className="font-serif text-lg font-bold text-[#FDFBF9]">Rigor</h4>
                <p className="text-xs text-[#FDFBF9]/75 font-medium leading-tight">Técnico Estratégico</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            >
              <div className="relative max-w-[280px] sm:max-w-sm mx-auto group">
                ...
                <div className="relative rounded bg-[#FDFBF9] p-2 border border-[#E0D9CD] shadow-lg overflow-hidden">
                  <div className="relative rounded overflow-hidden">
                    <img
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-y-0 left-0 w-[72%] bg-gradient-to-r from-[#071427]/85 via-[#1B365D]/45 to-transparent pointer-events-none"></div>
                    <div className="absolute inset-0 bg-gradient-to-r from-[#1B365D]/18 via-transparent to-transparent pointer-events-none"></div>
                  </div>
