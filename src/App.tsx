...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF9] font-sans text-[#2C3E50] antialiased selection:bg-[#E5D5C5] selection:text-[#1B365D]">
      ...
      {/* HERO SECTION */}
      <section id="inicio" className="relative min-h-[88vh] overflow-hidden">
        <img src={lawOfficeBg} alt="" className="absolute inset-0 w-full h-full object-contain md:object-cover object-center" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0B2249]/95 via-[#0B2249]/70 to-[#0B2249]/20"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="max-w-3xl">
            ...
            >
              ...
              <motion.h1 
                variants={fadeInUp} 
                className="font-serif text-[2.15rem] sm:text-4xl lg:text-5xl font-semibold tracking-tight text-white leading-[1.15]"
              >
              ...
              <motion.p 
                variants={fadeInUp} 
                className="text-sm sm:text-lg text-white/90 leading-relaxed max-w-xl"
              >
              ...
              <motion.div 
                variants={fadeInUp} 
                className="pt-6 sm:pt-8 border-t border-white/20 grid grid-cols-1 min-[380px]:grid-cols-3 gap-4"
              >
                <div>
                  <h4 className="font-serif text-lg font-bold text-white">100%</h4>
                  <p className="text-xs text-white/80 font-medium leading-tight">Confidencialidade</p>
                </div>
                <div>
                  <h4 className="font-serif text-lg font-bold text-white">Foco</h4>
                  <p className="text-xs text-white/80 font-medium leading-tight">Soluções Consensuais</p>
                </div>
                <div>
                  <h4 className="font-serif text-lg font-bold text-white">Rigor</h4>
                  <p className="text-xs text-white/80 font-medium leading-tight">Técnico Estratégico</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              <div className="relative max-w-[280px] sm:max-w-sm mx-auto group">
                ...
                <div className="relative rounded bg-[#FDFBF9] p-2 border border-[#E0D9CD] shadow-lg overflow-hidden">
                  <div className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-[#0B2249]/70 via-[#0B2249]/30 to-transparent z-10 pointer-events-none"></div>
                  <img
                    src={lawyerMarcelo}
